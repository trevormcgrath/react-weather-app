...
/***/ function(module, exports, __webpack_require__) {
	...
	var WeatherMsg = __webpack_require__(226);
	var openWeatherMap = __webpack_require__(227);
	var Loading = __webpack_require__(250);
	var ErrorMessage = __webpack_require__(251);
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement('input', { type: 'text', ref: 'location', placeholder: 'Enter a city. (eg: San Diego, London, etc...)' }),
					React.createElement(
						'button',
						null,
						'Search'
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OPEN_WEATHER_MAP_URL = 'http://api.openweathermap.org/data/2.5/weather?appid=0b3b3b58472a84afba688518b99d8d14&units=imperial';
